<?php   
 ...
 include("lib/class/pData.class.php");
 include("lib/class/pDraw.class.php");
 include("lib/class/pPie.class.php");
 include("lib/class/pImage.class.php");
 ...
 $myPicture->setFontProperties(array("FontName"=>"lib/fonts/Silkscreen.ttf","FontSize"=>6));
 ...
 $myPicture->setFontProperties(array("FontName"=>"lib/fonts/Silkscreen.ttf","FontSize"=>6,"R"=>255,"G"=>255,"B"=>255));
