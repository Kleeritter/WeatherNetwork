...
for (let i=0; i<jsonData.length;i++){
  if (jsonData[i]['sender_id'] == "langholzhausen" ) {
...
document.getElementById("Ortsname").innerHTML ="Langholzhausen";
...
document.getElementById("lonk").href="verden.php"; 
console.log(document.getElementById("lonk"));


window.indext=new Chart("indext", {
  type: "line",
  data:{ 
  labels: xValues,
    datasets: [{
...
window.indexp=new Chart("indexp", {
  type: "line",
  data: {
    labels: xValues,
    datasets: [{
...
var yValues = jshum;
window.indexh=new Chart("indexh", {
  type: "line",
  data:{ 
  labels: xValues,
    datasets: [{
